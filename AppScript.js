...
let  query = document.getElementById("srch-box");
...
let messageOnline = () => {
  message.textContent = "You are online. Ready to go !"
  message.style.cssText = "color: #fff";
;}

let messageOffline = () => {
  message.textContent = "You are offline. Some functions may not work without the internet !"
